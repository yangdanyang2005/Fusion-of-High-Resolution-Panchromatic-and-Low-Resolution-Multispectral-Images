...
<div style="display: flex; justify-content: space-between;">
    ...
    <div style="text-align: center;">
        ...
        <img src="https://github.com/yangdanyang2005/Fusion-of-High-Resolution-Panchromatic-and-Low-Resolution-Multispectral-Images/blob/main/SDPNet-for-pansharpening/results/homework/output_homework.tiff" width="600" height="540"/>
    </div>
</div>
